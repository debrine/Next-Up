...
let operativeAbilityList: {[key:string]:{
    ...
    '1':{
        abilityName:['OPERATIVE\'S EDGE (EX)', 'SPECIALIZAION', 'TRICK ATTACK [EX]'],
        abilityDescription: [
