            ...
            <div className={styles.attributeBox}>
                ...
                <div className={styles.inputDiv}>
                    <div className={styles.scoreModifierColumn}>
                        ...
                        <input 
                            type="number"
                            value={(Number(strengthAbility.value) + Number(strengthAbility.asBonus) - Number(strengthAbility.asPenalty)).toString()}
                            readOnly
                        />
                        <input 
                            type="number"
                            value={(Number(dexterityAbility.value) + Number(dexterityAbility.asBonus) - Number(dexterityAbility.asPenalty)).toString()}
                            readOnly
                        />
                        <input 
                            type="number"
                            value={(Number(constitutionAbility.value) + Number(constitutionAbility.asBonus) - Number(constitutionAbility.asPenalty)).toString()}
                            readOnly
                        />
                        <input 
                            type="number"
                            value={(Number(intelligenceAbility.value) + Number(intelligenceAbility.asBonus) - Number(intelligenceAbility.asPenalty)).toString()}
                            readOnly
                        />
                        <input 
                            type="number"
                            value={(Number(wisdomAbility.value) + Number(wisdomAbility.asBonus) - Number(wisdomAbility.asPenalty)).toString()}
                            readOnly
                        />
                        <input 
                            type="number"
                            value={(Number(charismaAbility.value) + Number(charismaAbility.asBonus) - Number(charismaAbility.asPenalty)).toString()}
                            readOnly
                        />
                    </div>
                    <div className={styles.scoreModifierColumn}>
                        ...
                        <input 
                            type="number"
                            value={Math.floor(((Number(strengthAbility.value) + Number(strengthAbility.asBonus) - Number(strengthAbility.asPenalty))/2)-5).toString()}
                            readOnly
                        />
                        <input 
                            type="number"
                            value={Math.floor(((Number(dexterityAbility.value) + Number(dexterityAbility.asBonus) - Number(dexterityAbility.asPenalty))/2)-5).toString()}
                            readOnly
                        />
                        <input 
                            type="number"
                            value={Math.floor(((Number(constitutionAbility.value) + Number(constitutionAbility.asBonus) - Number(constitutionAbility.asPenalty))/2)-5).toString()}
                            readOnly
                        />
                        <input 
                            type="number"
                            value={Math.floor(((Number(intelligenceAbility.value) + Number(intelligenceAbility.asBonus) - Number(intelligenceAbility.asPenalty))/2)-5).toString()}
                            readOnly
                        />
                        <input 
                            type="number"
                            value={Math.floor(((Number(wisdomAbility.value) + Number(wisdomAbility.asBonus) - Number(wisdomAbility.asPenalty))/2)-5).toString()}
                            readOnly
                        />
                        <input 
                            type="number"
                            value={Math.floor(((Number(charismaAbility.value) + Number(charismaAbility.asBonus) - Number(charismaAbility.asPenalty))/2)-5).toString()}
                            readOnly
                        />
                    </div>
